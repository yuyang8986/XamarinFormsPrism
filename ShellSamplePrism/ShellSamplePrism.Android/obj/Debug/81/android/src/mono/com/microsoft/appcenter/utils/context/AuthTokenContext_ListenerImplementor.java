...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"n_onNewUser:(Lcom/microsoft/appcenter/UserInformation;)V:GetOnNewUser_Lcom_microsoft_appcenter_UserInformation_Handler:Com.Microsoft.Appcenter.Utils.Context.AuthTokenContext/IListenerInvoker, Microsoft.AppCenter.Android.Bindings\n" +
	...
	public void onNewUser (com.microsoft.appcenter.UserInformation p0)
	{
		n_onNewUser (p0);
	}

	private native void n_onNewUser (com.microsoft.appcenter.UserInformation p0);
