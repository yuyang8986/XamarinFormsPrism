...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("BuildIt.Forms.Controls.Platforms.Android.CameraStateListener, BuildIt.Forms.Controls", CameraStateListener.class, __md_methods);
	}
	...
	public CameraStateListener ()
	{
		...
		if (getClass () == CameraStateListener.class)
			mono.android.TypeManager.Activate ("BuildIt.Forms.Controls.Platforms.Android.CameraStateListener, BuildIt.Forms.Controls", "", this, new java.lang.Object[] {  });
	}

	public CameraStateListener (md591c3b7381cd8e618f2bb5a45734b5f3e.CameraPreviewControlRenderer p0)
	{
		super ();
		if (getClass () == CameraStateListener.class)
			mono.android.TypeManager.Activate ("BuildIt.Forms.Controls.Platforms.Android.CameraStateListener, BuildIt.Forms.Controls", "BuildIt.Forms.Controls.Platforms.Android.CameraPreviewControlRenderer, BuildIt.Forms.Controls", this, new java.lang.Object[] { p0 });
	}
